...
DROP POLICY IF EXISTS "Authenticated access to medicines" ON medicines;
...
DROP POLICY IF EXISTS "Authenticated access to materials" ON materials;
...
DROP POLICY IF EXISTS "Authenticated access to bills" ON bills;
...
DROP POLICY IF EXISTS "Authenticated access to bill_items" ON bill_items;
...
DROP POLICY IF EXISTS "Authenticated access to purchases" ON purchases;
